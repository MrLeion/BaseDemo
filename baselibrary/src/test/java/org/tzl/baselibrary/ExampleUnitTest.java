package org.tzl.baselibrary;

import org.junit.Test;

import static org.hamcrest.CoreMatchers.equalTo;
import static org.hamcrest.MatcherAssert.assertThat;
import static org.tzl.baselibrary.utils.ConvertUtils.hexString2Bytes;
import static org.tzl.baselibrary.utils.EncryptUtils.encryptDES;
import static org.tzl.baselibrary.utils.EncryptUtils.encryptDES2HexString;
import static org.tzl.baselibrary.utils.EncryptUtils.encryptHmacMD5;
import static org.tzl.baselibrary.utils.EncryptUtils.encryptHmacMD5ToString;
import static org.tzl.baselibrary.utils.EncryptUtils.encryptHmacSHA1;
import static org.tzl.baselibrary.utils.EncryptUtils.encryptHmacSHA1ToString;
import static org.tzl.baselibrary.utils.EncryptUtils.encryptMD2ToString;
import static org.tzl.baselibrary.utils.EncryptUtils.encryptMD5;
import static org.tzl.baselibrary.utils.EncryptUtils.encryptMD5ToString;
import static org.tzl.baselibrary.utils.EncryptUtils.encryptSHA1;
import static org.tzl.baselibrary.utils.EncryptUtils.encryptSHA1ToString;
...
public class ExampleUnitTest {
    ...
    private String MrLeionMD2    = "80FCA75C4A103162D26681E1379280D1";
    private String MrLeionMD5    = "B5A8963A537D8825BCFCA3D4A69381B5";
    private String MrLeionSHA1   = "F98902BF3B4685AAC694EC53C151463A7E135FB5";
    ...
    public void testEncryptMD2() throws Exception {
        assertThat(encryptMD2ToString("MrLeion"),equalTo(MrLeionMD2));
        assertThat(encryptMD2ToString("MrLeion".getBytes()),equalTo(MrLeionMD2));
    }

    @Test
    public void testEncryptMD5() throws Exception {
        assertThat(encryptMD5ToString("MrLeion"),equalTo(MrLeionMD5));
        assertThat(encryptMD5ToString("MrLeion".getBytes()),equalTo(MrLeionMD5));
        assertThat(encryptMD5("MrLeion".getBytes()),equalTo(hexString2Bytes(MrLeionMD5)));
    }

    @Test
    public void testEncryptSHA1() throws Exception {
        assertThat(encryptSHA1ToString("MrLeion"),equalTo(MrLeionSHA1));
        assertThat(encryptSHA1ToString("MrLeion".getBytes()),equalTo(MrLeionSHA1));
        assertThat(encryptSHA1("MrLeion".getBytes()),equalTo(hexString2Bytes(MrLeionSHA1)));
    }
//
//    @Test
...
//    }
    ...
    private String MrLeionHmacMD5    = "C61AE6637C4E3040EBEB07413C0CB4CF";
    private String MrLeionHmacSHA1   = "B65EE45250F6811596E263F2604D2CD6DF0DC433";
    ...
    private String MrLeionHmackey    = "MrLeion";

    @Test
    public void testEncryptHmacMD5() throws Exception {
        assertThat(encryptHmacMD5ToString("MrLeion", MrLeionHmackey),equalTo(MrLeionHmacMD5));
        assertThat(encryptHmacMD5ToString("MrLeion".getBytes(), MrLeionHmackey.getBytes()),equalTo(MrLeionHmacMD5));
        assertThat(encryptHmacMD5("MrLeion".getBytes(), MrLeionHmackey.getBytes()),equalTo(hexString2Bytes(MrLeionHmacMD5)));
    }

    @Test
    public void testEncryptHmacSHA1() throws Exception {
        assertThat(encryptHmacSHA1ToString("MrLeion", MrLeionHmackey),equalTo(MrLeionHmacSHA1));
        assertThat(encryptHmacSHA1ToString("MrLeion".getBytes(), MrLeionHmackey.getBytes()),equalTo(MrLeionHmacSHA1));
        assertThat(encryptHmacSHA1("MrLeion".getBytes(), MrLeionHmackey.getBytes()),equalTo(hexString2Bytes(MrLeionHmacSHA1)));
    }
//
//    @Test
...
//
    ...
    public void testEncryptDES() throws Exception {
        assertThat(encryptDES(bytesDataDES, bytesKeyDES),equalTo(bytesResDES));
        assertThat(encryptDES2HexString(bytesDataDES, bytesKeyDES),equalTo(resDES));
    }
//
//    @Test
